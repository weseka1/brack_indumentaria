...
export default function ProfileGate() {
  ...
  return (
    <div className="panel-bg fixed inset-0 z-[60] flex flex-col items-center justify-center px-6 py-10">
      ...
      <div className="mb-1 text-[11px] font-semibold uppercase tracking-widest2 text-brand">Brack Indumentaria · Panel</div>
      <h1 className="text-center font-display text-3xl font-semibold tracking-tight text-graph sm:text-4xl">¿Quién está usando el panel?</h1>
      ...
      {manage && activo.admin && (
        <div className="mt-9 w-full max-w-2xl rounded-2xl border border-graph/10 bg-paper-100 p-5 text-left shadow-soft">
          ...
          <p className="mt-0.5 text-xs text-graph-400">Todos ven Bandeja, Pedidos, Productos, Cargar producto, Service y Clientes. Sumales secciones o hacelos administradores.</p>
