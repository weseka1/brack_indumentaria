      ...
      >
        ...
        <div className="px-8 pt-8 text-center">
          ...
          <h2 className="mt-4 font-display text-2xl text-graph">
            {modo === "registrar" ? "Crear cuenta" : "Ingresar a su cuenta"}
          </h2>
          <p className="mt-1 text-sm text-graph-500">
            {modo === "registrar"
              ? "Para guardar favoritos y seguir sus pedidos y consultas."
              : "Acceda a sus favoritos, pedidos y consultas."}
          </p>
        </div>
        ...
        <form onSubmit={submit} className="space-y-3 p-8 pt-6">
          ...
          <p className="pt-2 text-center text-sm text-graph-500">
            {modo === "registrar" ? "¿Ya tiene cuenta?" : "¿No tiene cuenta?"}{" "}
            <button
              type="button"
              onClick={() => {
                setError("");
            ...
            >
              {modo === "registrar" ? "Ingresar" : "Registrarse"}
            </button>
          </p>
        </form>
      </div>
